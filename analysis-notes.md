...
- Final respondent sample: **150 adults**.
- Valid adult pins after coordinate repair/cleaning: **545**.
- Public map: **530** adult pins within 5 km of the forest-centre reference point; 15 more distant adult pins are not published in the spatial story.
...
The 11 multispecies statements separate cleanly into two factors in the adult sample. Parallel analysis retains two factors; the seven forest/coexistence items load on the first and the four institutional-recognition items on the second.
...
- 88.7% of adults score coexistence higher than institutional recognition.
- 60.7% differ by at least two full scale points.
- Correlation between the two scales: r = -0.041.

## Path model

The adult-only path model uses the same supplied specification. Fit:
...
The supplied HC3 regression sequence is recomputed after the adult exclusion.
